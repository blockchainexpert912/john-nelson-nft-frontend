      ...
      <div className="bg-[#5D564C] md:py-28 py-8">
        <div className="container mx-auto 2xl:px-0 px-4 flex md:justify-between xl:gap-8 gap-5 xl:flex-nowrap flex-wrap xl:max-w-[1200px] w-full items-center">
          <div className="lg:max-w-[500px] w-full">
            <h1 class="text-white md:text-[44px] text-[22px] font-normal eb uppercase lg:leading-[52.80px] tracking-[5px] md:mb-10 mb-6">
              About artist
            </h1>
          ...
          <div className="lg:max-w-[630px] w-full">
            <h1 class="text-white md:text-[44px] text-[22px] font-normal eb leading-[52.80px]">
              John Nelson
            </h1>
            <p class="text-white md:text-lg text-base font-normal lg:leading-[27px] md:mt-2 mb-4">
              Master Pencil Artist
            </p>
            <p class="text-[#C9C8C8] md:text-lg text-xs font-normal lg:leading-[27px]">
