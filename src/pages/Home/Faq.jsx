    ...
    <>
      <div className="bg-[#1B1716] md:pt-28 md:pb-28 pt-10 pb-8">
        <div className="container mx-auto 2xl:px-0 px-4 xl:max-w-[1200px] w-full">
          <h1 class="text-white md:text-[44px] text-[22px] font-normal eb uppercase">
            Frequently asked questions
          </h1>
          <p class="lg:max-w-[1022px] w-full opacity-70 text-[#C9C8C8] md:text-[23px] text-base font-normal lg:leading-[34.50px] mt-3 mb-6">
