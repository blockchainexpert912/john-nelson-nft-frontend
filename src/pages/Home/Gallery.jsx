  ...
  return (
    <>
      <div className="md:pt-28 pt-8 md:pb-28 pb-9 bg-[#46382D]">
            ...
            >
              <SwiperSlide>
                <div className="md:px-0 px-0 w-full mx-auto">
                  <img src={Gallery} alt="Up" className="w-full" />
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className="md:px-0 px-0 w-full mx-auto">
        ...
        <button className="flex items-center justify-center group md:h-[60px] md:w-[265px] w-[230px] mx-auto md:mt-12 mt-1 h-[40px] gap-3 bg-[#CEC2AC] text-center text-[#46382D] md:text-lg text-sm font-medium hover:bg-[#46382D] hover:text-[#CEC2AC] group border border-transparent hover:border-[#CEC2AC] ease-in-out transform duration-300">
        Enter the  Metaverse
          <svg
