...
function Navbar() {
  ...
  return (
    <nav className="pt-[0px] w-full z-[500] bg-[#211C19] fixed">
      <div className="container mx-auto xl:max-w-[1200px] w-full">
              ...
              return (
                ...
                >
                  <Link
                    onClick={headeritems}
                    to={v.link}
                    className={`text-[#797164] hover:text-[#CEC2AC] border-b border-transparent xl:text-lu-secondary xl:font-[500] text-base hover:text-lu-primary-2 font-normal xl:hover:text-lu-dark ${
                  ...
                  {v?.list && (
                    <ul className="dropdown_list nav_arrow text-[#797164] xl:hidden group-hover:block box-shadow-dropdown static xl:absolute xl:top-[70px] xl:bg-lu-white xl:shadow-dropdown">
                      {v?.list.map((j) => {
                        return (
